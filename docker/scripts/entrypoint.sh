...
mkdir -p "${CONFIG_DIR}" "${SECRETS_DIR}" "${PLUGINS_DIR}" "${PROVIDERS_DIR}" "${CREDENTIALS_DIR}" "${NAGIENT_STATE_DIR:-/var/lib/nagient/state}" "${NAGIENT_LOG_DIR:-/var/lib/nagient/logs}" "${NAGIENT_RELEASES_DIR:-/var/lib/nagient/releases}"
