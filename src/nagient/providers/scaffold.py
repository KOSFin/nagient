    ...
    return "\n".join(
        [
            ...
            (
                ...
                '"models_path", "timeout_seconds", "retry_attempts", '
            ...
            'key = "base_url"',
            'label = "Base URL"',
            'help_text = "Root HTTP endpoint for the provider API."',
            'value_type = "string"',
            'category = "connection"',
            "required = true",
            "",
            ...
            'help_text = "Secret name that stores the provider API key."',
            'value_type = "secret"',
            'category = "connection"',
            "secret = true",
            "",
            ...
            'key = "model"',
            'label = "Default model"',
            'help_text = "Model identifier used for chat calls."',
            'value_type = "string"',
            'category = "connection"',
            "",
            "[[config_fields]]",
            'key = "models_path"',
            'label = "Models path"',
            'help_text = "Optional relative path used for model discovery."',
            'value_type = "path"',
            'category = "advanced"',
            "",
            "[[config_fields]]",
            ...
            'help_text = "Per-attempt network timeout budget in seconds."',
            'value_type = "integer"',
            'category = "advanced"',
            "",
            "[[config_fields]]",
            ...
            'help_text = "How many times Nagient should retry transient provider failures."',
            'value_type = "integer"',
            'category = "advanced"',
            "",
            "[[config_fields]]",
            ...
            'label = "Retry backoff"',
            'help_text = "Base delay between retry attempts for transient provider errors."',
            'value_type = "number"',
            'category = "advanced"',
            "",
        ]
...
def _render_provider_python(plugin_id: str) -> str:
    return "\n".join(
        [
            ...
            "    ) -> list[ProviderModel]:",
            "        del provider_id, config, secrets, credential",
            "        self.runtime_log(\"Listing models through the custom provider runtime.\")",
            "        return [",
            "            ProviderModel(",
