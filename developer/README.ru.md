...
| --- | --- |
| [Модель релизов](#1-модель-релизов) | Версия, tags, артефакты, Docker и update center. |
| [Централизованная конфигурация](#2-централизованная-конфигурация) | Источники для рендера release assets. |
| [Runtime layout](#3-runtime-layout) | Постоянные файлы, state и workspace. |
| [GitHub variables и secrets](#4-github-variables-и-secrets) | Настройки репозитория. |
| [Локальная разработка](#5-локальная-разработка) | Окружение и quality gates. |
| [Bootstrap и reconcile](#6-bootstrap-и-reconcile) | Локальный activation workflow. |
| [Чеклист релиза](#7-чеклист-релиза) | Последовательность проверки публикации. |
| [Матрица изменений](#8-матрица-изменений) | Ownership по файлам и подсистемам. |
| [Ограничения](#9-ограничения-и-инварианты) | Контракты, которые нельзя ломать. |
