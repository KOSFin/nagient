...
Общий раздел манифеста может содержать:
...
Установщик создаёт отдельное `.venv` внутри каталога конкретного плагина и
использует его при импорте Python-плагина или запуске его process entrypoint.
